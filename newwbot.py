...
def start_bot():
    ...
    def next_menu(message):
         ...
         if message.text in menu.tovar_list:
             ...
             buy_text = "➖➖➖➖➖➖➖➖➖➖\n" \
               "Вы выбрали: \n" \
               "Город: {settings.citydict[userid]} \n" \
               "Район:{settings.rayondict[userid]}\n" \
               "Товар: {settings.tovardict[userid]}\n" \
               "➖➖➖➖➖➖➖➖➖➖\n" \
               ...
               "➖➖➖➖➖➖➖➖➖➖\n" \
               "🏷️QIWI кошелек: {config.qiwi_number} \n" \
               "💲Сумма к оплате: {settings.pricedict[userid]} рублей\n" \
         ...
         if message.text not in menu.all_list:
               start_text = "Местная Аптека💥Телеграмм 24💥 \n" \
                      "💥Telegram24💥\n" \
                      "➖➖➖➖➖➖\n" \
